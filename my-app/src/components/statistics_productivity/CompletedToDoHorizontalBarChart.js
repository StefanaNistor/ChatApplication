...
function CompletedToDoHorizontalBarChart() {
          ...
          datasets: [
            {
              ...
              data: users.map(
                (user) =>
                  todos.filter((todo) => todo.user_id === user.id).length
              ),
...
export default CompletedToDoHorizontalBarChart;
