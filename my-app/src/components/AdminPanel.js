...
function AdminPanel() {
  ...
  async function getAllButCurrentUser() {
    ...
    try {
      const response = await axios.get(
        `http://localhost:7979/users/allUsers/${userID}`,
        {
          headers: {
  ...
  async function getGroupMembers(groupID) {
    try {
      const response = await axios.get(
        `http://localhost:7979/groupChat/members/${groupID}`,
        {
          headers: {
            "x-access-token": localStorage.getItem("token"),
          },
  ...
  const handleCreateUser = () => {
    ...
    if (age < 18 || age > 70) {
      alert(
        "User must be at least 18 years old and no older than 70 years old!"
      );
      return;
    }
    ...
    axios
      .post("http://localhost:7979/users/create", newUser, { headers })
      .then((res) => {
        ...
        return axios.post(
          "http://localhost:7979/userDetails/create",
          userDetail,
          { headers }
        );
      })
  ...
  const handleChangeUserDetails = () => {
    ...
    if (newUsername) {
      axios
        .put(
          `http://localhost:7979/users/updateUsername/${editedUserID}`,
    ...
    if (newFirstName) {
      axios
        .put(
          `http://localhost:7979/userDetails/updateFirstname/${editedUserID}`,
    ...
    if (newLastName) {
      axios
        .put(
          `http://localhost:7979/userDetails/updateLastname/${editedUserID}`,
    ...
    if (newPassword) {
      axios
        .put(
          `http://localhost:7979/users/updatePassword/${editedUserID}`,
    ...
    if (newPosition) {
      axios
        .put(
          `http://localhost:7979/userDetails/updatePosition/${editedUserID}`,
    ...
    if (isCheckedUpdate) {
      axios
        .put(
          `http://localhost:7979/users/updateIsAdmin/${editedUserID}`,
          { isAdmin: isCheckedUpdate },
          {
            headers: {
              "x-access-token": localStorage.getItem("token"),
            },
    ...
    if (
      (newBirthday && new Date(newBirthday) > new Date()) ||
      new Date().getFullYear() - new Date(newBirthday).getFullYear() < 18 ||
      new Date().getFullYear() - new Date(newBirthday).getFullYear() > 100
    ) {
      ...
      axios
        .put(
          `http://localhost:7979/userDetails/updateDateOfBirth/${editedUserID}`,
  ...
  const handleConfirmDelete = () => {
    ...
    axios
      .delete(`http://localhost:7979/users/${deletedUserId}`, {
        headers: {
          "x-access-token": localStorage.getItem("token"),
        },
      })
      ...
      .catch((err) => {
        ...
        document
          .querySelector(".delete-user-section")
  ...
  const handleCreateGroup = () => {
    ...
    axios
      .post("http://localhost:7979/groupChat/createGroup", newGroup, {
        headers: {
          "x-access-token": localStorage.getItem("token"),
        },
      })
      ...
      .catch((err) => {
        ...
        document
          .querySelector(".create-group-section")
          .appendChild(errorMessage);
        setTimeout(() => {
          errorMessage.remove();
        }, 3000);
  ...
  const handleDeleteGroup = () => {
    const deletedGroupId = document.getElementById(
      "delete-group-dropdown"
    ).value;
    axios
      .delete(`http://localhost:7979/groupChat/deleteGroup/${deletedGroupId}`, {
        headers: {
          "x-access-token": localStorage.getItem("token"),
        },
      })
      ...
      .catch((err) => {
        ...
        document
          .querySelector(".delete-group-section")
          .appendChild(errorMessage);
        setTimeout(() => {
          errorMessage.remove();
        }, 3000);
  ...
  const handleAddUserGroup = () => {
    ...
    axios
      .post(
        `http://localhost:7979/groupChat/addMember`,
        { groupID, userID },
        {
          headers: {
            "x-access-token": localStorage.getItem("token"),
      ...
      .catch((err) => {
        ...
        document
          .querySelector(".add-remove-user-section")
          .appendChild(errorMessage);
        setTimeout(() => {
          errorMessage.remove();
        }, 1000);
  ...
  const handleRemoveUserGroup = () => {
    ...
    axios
      .delete(`http://localhost:7979/groupChat/removeMember`, {
        headers: {
          "x-access-token": localStorage.getItem("token"),
        },
        data: {
  ...
  const handleChangeGroupDetails = () => {
    const editedGroupID = document.getElementById(
    ...
    if (newGroupName) {
      axios
        .put(
          `http://localhost:7979/groupChat/updateGroup/${editedGroupID}`,
          { name: newGroupName },
          {
            headers: {
              "x-access-token": localStorage.getItem("token"),
    ...
    if (selectedFileNew) {
      ...
      document
        .querySelector(".change-group-details-section")
        .appendChild(message);
      setTimeout(() => {
        message.remove();
        window.location.reload();
  ...
  const handleFileUpload = (groupID) => {
    ...
    axios
      .post(
        `http://localhost:7979/photos/uploadGroupPhoto/${groupID}`,
        formData,
        {
          headers: {
            "x-access-token": localStorage.getItem("token"),
      ...
      <div className="admin-panel">
        <div className="admin-panel-CRUD-section">
          <div className="create-user-section">
            ...
            <button id="create-user-btn" onClick={handleCreateUser}>
              Create User
            </button>
          </div>
          ...
          >
            <div className="delete-user-section">
              ...
              <button id="delete-user-btn" onClick={handleDelete}>
                Delete User
              </button>
              <button
            ...
            <div className="create-group-section">
              ...
              />
              <button id="addPhoto" onClick={handleUpdatePhoto}>
                Add Photo
              </button>
              <input
                type="file"
          ...
          <div className="delete-group-section">
            ...
            <button id="delete-group-btn" onClick={handleDeleteClick}>
              Delete Group
            </button>
            <button
              id="delete-group-confirm-btn"
              style={{ display: "none" }}
          ...
          <div className="add-remove-user-section">
            ...
            <button id="add-user-group-btn" onClick={handleAddUserGroup}>
              Add User to Group
            </button>
            ...
            <button id="remove-user-group-btn" onClick={handleRemoveUserGroup}>
          ...
          <div className="change-group-details-section">
            ...
            />
            <button id="change-group-photo" onClick={handleUpdatePhotoNew}>
              {" "}
              Change Group Photo{" "}
            </button>
            <input
            ...
            <button
              id="change-group-details-btn"
              onClick={handleChangeGroupDetails}
            >
